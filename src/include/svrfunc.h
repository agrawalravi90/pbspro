...
extern void update_job_node_rassn(job *, const attribute *, enum batch_op);
...
extern int apply_aoe_inchunk_rules(resource *, void *, int);
...
extern int make_schedselect(resource *, pbs_queue *, attribute *);
...
extern void  update_node_rassn(const attribute *, enum batch_op);
extern void  update_job_node_rassn(job *, const attribute *, enum batch_op);
...
extern int   set_chunk_sum(const attribute  *pselectattr, attribute *pattr);
extern int   update_resources_rel(job *, enum batch_op);
...
#endif /* _PBS_JOB_H */
#ifdef _QUEUE_H
extern int chk_resc_limits(const attribute *, pbs_queue *);
