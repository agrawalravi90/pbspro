 ...
 *                           is run.
 */
bool update_node_on_run(nspec *ns, resource_resv *resresv, const char *job_state);
 ...
 */
bool update_node_on_end(node_info *ninfo, resource_resv *resresv, const char *job_state);
